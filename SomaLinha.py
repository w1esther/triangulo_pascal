...
class SomaLinhaPascal(Scene):
    def construct(self):
        # 1. Título Inicial
        title = MathTex(r"\text{Soma dos Termos de uma Linha: } \sum_{k=0}^{n} C_n^k = 2^n", font_size=24)
        ...
        eq_text1.to_edge(DOWN, buff=0.4)
        ...
        # 5. Encerramento
        final_text = MathTex(r"\text{A soma dos elementos de uma linha qualquer } n \text{ é sempre igual a } 2^n.", font_size=22)
